<form method="post">
	<p>
		<label style="display:inline;" for="from"><?php _e( 'From:', 'topgroupshops' ); ?></label>
		<input class="date-pick" type="date" name="start_date" id="from"
			   value="<?php echo esc_attr( date( 'Y-m-d', $start_date ) ); ?>"/>

		<label style="display:inline;" for="to"><?php _e( 'To:', 'topgroupshops' ); ?></label>
		...
		<input type="submit" class="btn btn-inverse btn-small" style="float:none;"
			   value="<?php _e( 'Show', 'topgroupshops' ); ?>"/>
	</p>
</form>